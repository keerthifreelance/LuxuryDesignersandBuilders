...
export const FaqSection: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'You can contact us via phone at +91 96004 70328, via email, or by filling out our site consultation form on this website. Our principal office is located in Lakshmi Nagar, West St, Kalloorani, Aruppukkottai, Tamil Nadu.'
    }
  ];
